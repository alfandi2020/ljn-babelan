<section id="basic-input">
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary" href="<?= base_url(
                        'pelanggan/list'
                    ) ?>"> <i class="feather icon-arrow-left"></i></a>
                ...
                <?php } ?>
                     ...
                     <div class="tab-content pt-1">
                        <div class="tab-pane active" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
                            <form onSubmit="return confirm('Ingin Update Pelanggan <?= $pelanggan[
                                'nama'
     ...
     'pelanggan/update'
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <input name="id_update" type="hidden" value="<?= $this->uri->segment(
                                            3
                                        ) ?>">
                                         <?php
                                         ...
                                         echo 'Pelanggan Aktif : <b>' .
                                             $pelanggan['aktif'] .
                                             '</b>' .
                                             '<br>';
                                         echo 'Lama berlangganan :  <b>' .
                                             count($k) .
                                             ' Bulan </b>';
                                         ?> </b>
                                        <div class="row mt-2">
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <select  name="media" class="select2 form-control">
                                                        ...
                                                        <option <?= $pelanggan[
                                                            ...
                                                            ? 'selected'
                                                            : '' ?> value="LAN">LAN</option>
                                                        <option <?= $pelanggan[
                                                            'layanan'
                                                        ] == 'Fiber Optik'
                                                            ? 'selected'
                                                            : '' ?> value="Fiber Optik">Fiber Optik</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 mb-1">
                                                    ...
                                                    <select required name="speed_x" class="select2 form-control">
                                                        ...
                                                        foreach (
                                                            ...
                                                            <option <?= $pelanggan[
                                                                ...
                                                                ? 'selected'
                                                                : '' ?> value="<?= $x->id_paket ?>"><?= $x->mbps .
    'Mbps - Rp.' .
    number_format($x->harga, 0, '.', '.') .
    ' - ' .
    $x->paket_internet ?></option>    
                                                        <?php }
                                                        ?>
                                                    </select>
                                                </fieldset>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 mb-1">
                                                <span>Kode Unik</span>
                                                <input type="text" name="kode_unik" class="form-control" value="<?= $pelanggan[
                                                    'kode_unik'
                                                ] ?>">
                                            </div>
                                            <div class="col-xl-4">
                                                ...
                                                $cek = $this->db
                                                    ->query(
                                                        "SELECT * FROM dt_registrasi as a left join mt_paket as b on(a.speed = b.id_paket) where id='$idd'"
                                                    )
                                                    ->row_array();
                                                if ($cek['mbps'] == false) { ?>
                                                        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-12 mb-1">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <a href="<?= base_url(
                                                            'pelanggan/aktif/' .
                                                                $pelanggan['id']
                                                        ) ?>" class="btn btn-success delete-confirm url">Aktifkan</a>
                                                    </fieldset>
                                                </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-xl-4 col-md-6 col-12 mb-1">
                                                <fieldset class="form-group">
                                                    <span>Router</span>
                                                    <input type="text" value="<?= $pelanggan[
                                                        'router'
                                                    ] ?>"  name="router" class="form-control" placeholder="Router Huawei">
                                                </fieldset>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 mb-1">
                                                <fieldset class="form-group">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $pelanggan[
                                                        'nama'
                                                    ] ?>" name="nama" class="form-control" placeholder="asep" >
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <input type="number" value="<?= $pelanggan[
                                                    'ktp'
                                                ] ?>" name="nomor" class="form-control" placeholder="3175">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <fieldset class="form-group">
                                                    <span>No NPWP</span>
                                                    <input type="number" value="<?= $pelanggan[
                                                        'npwp'
                                                    ] ?>" name="npwp" class="form-control" placeholder="123" >
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-xl-4">
                                                ...
                                                <select name="group" id="" class="select2">
                                                    ...
                                                    <!-- <option selected value="<?= $pelanggan[
                                                        'group'
                                                    ] ?>"><?= $pelanggan[
    'group'
] ?></option> -->
                                            ...
                                            <div class="col-xl-4">
                                                <span>Alamat</span>
                                                <input type="text" class="form-control" value="<?= $pelanggan[
                                                    'alamat'
                                                ] ?>" name="alamat" placeholder="Wahana Blok F">
                                            </div>
                                        
                                            <div class="col-xl-4">
                                                <span>Kode Pelanggan</span>
                                                <input type="text" class="form-control" name="kode_pelanggan" placeholder="WP123" value="<?= $pelanggan[
                                                    'kode_pelanggan'
                                                ] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                                <span>Email</span>
                                                <input type="email" name="email" value="<?= $pelanggan[
                                                    'email'
                                                ] ?>" class="form-control" placeholder="info@gmail.com">
                                            </div>
                                            <div class="col-xl-4">
                                                    <span>Teknisi</span>
    ...
    'teknisi'
                                                            ...
                                                            <option <?= $pelanggan[
                                                                ...
                                                                ? 'selected'
                                                                : '' ?> value="<?= $x->id_teknisi ?>"><?= $x->nama ?></option>
                                                        <?php }
                                                        ?>
                                                    ...
                                                    <!-- <input type="text" name="teknisi" value="<?= $pelanggan[
                                                        'teknisi'
                                                    ] ?>" class="form-control" placeholder="asep"> -->
                                                </div>
                                            <div class="col-xl-4">
                                                <span>Kontak Handphone / Telp</span>
                                                <input type="number"  name="telp" value="<?= $pelanggan[
                                                    'telp'
                                                ] ?>" class="form-control" placeholder="081111">
                                            </div>
                                        </div>
                                        <br>
                                                ...
                                                <fieldset>
                                                    <div class="vs-radio-con vs-radio-primary">
                                                        <input <?= $pelanggan[
                                                            ...
                                                            ? 'checked'
                                                            : '' ?> type="radio" name="tindakan" value="Pribadi">
                                                ...
                                                <fieldset>
                                                    <div class="vs-radio-con vs-radio-primary">
                                                        <input <?= $pelanggan[
                                                            ...
                                                            ? 'checked'
                                                            : '' ?>  type="radio" name="tindakan" value="Pemberi Kuasa">
                                                        <span class="vs-radio vs-radio-lg">
                                                            <span class="vs-radio--border"></span>
                                                            <span class="vs-radio--circle"></span>
                                                        </span>
                                                ...
                                                <fieldset>
                                                    <div class="vs-radio-con vs-radio-primary">
                                                        <input <?= $pelanggan[
                                                            ...
                                                            ? 'checked'
                                                            : '' ?> type="radio" name="tindakan" value="Perusahaan">
                                                        <span class="vs-radio vs-radio-lg">
                                                            <span class="vs-radio--border"></span>
                                                            <span class="vs-radio--circle"></span>
                                                        </span>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $pelanggan[
                                                        't_nama'
                                                    ] ?>" name="t_nama" class="form-control" placeholder="asep" >
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <input type="number" value="<?= $pelanggan[
                                                    't_nomor_ktp'
                                                ] ?>" name="t_nomor" class="form-control" placeholder="3175">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12">
                                                <fieldset class="form-group">
                                                    <span>No NPWP</span>
                                                    <input type="number" value="<?= $pelanggan[
                                                        't_npwp'
                                                    ] ?>" name="t_npwp" class="form-control" placeholder="123" >
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-xl-4">
                                                ...
                                                <input type="number" value="<?= $pelanggan[
                                                    't_telp'
                                                ] ?>" name="t_telp" class="form-control" placeholder="081111">
                                            </div>
                                            <div class="col-xl-4">
                                                <span>Email</span>
                                                <input type="email" value="<?= $pelanggan[
                                                    't_email'
                                                ] ?>"  name="t_email" class="form-control" placeholder="info@gmail.com">
                                            </div>
                                            <div class="col-xl-4">
                                                <span>Tanggal Aktif</span>
                                                <input type="date" value="<?= $pelanggan[
                                                    'aktif'
                                                ] ?>"  name="aktif" class="form-control">
                                            </div>
                                        </div>
                                        <!-- <div class="row">
                                            <div class="col-xl">
